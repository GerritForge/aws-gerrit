...
Current email notification configuration was tested with Amazon Simple Email Service.
Details how setup SMTP service with Amazon SES can be found [here](https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-set-up.html).
